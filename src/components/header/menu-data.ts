...
const popularBlockchains: GridItemProps[] = [
  {
...
export function getMenuItems(t: Translations): MenuItem[] {
  const investmentSections: MenuSectionData[] = [
    {
      type: "grid",
  ...
  const rpcSections: MenuSectionData[] = [
    {
      type: "multi_grid",
  ...
  const eventsAndCommunitySection: MenuSectionData = {
    type: "list",
  ...
  const servicesSections: MenuSectionData[] = [
    {
      type: "list",
      ...
      items: [
        ...
        },
        {
          ...
          subItems: [
            {
              label:
                t.menu.services.whitelabelValidation.subItems.btcMining.label,
              description:
                t.menu.services.whitelabelValidation.subItems.btcMining
                  .description,
              href: "",
            },
            {
              label:
                t.menu.services.whitelabelValidation.subItems.ethValidation
                  .label,
              description:
                t.menu.services.whitelabelValidation.subItems.ethValidation
                  .description,
  ...
  const productsSections: MenuSectionData[] = [
    {
      type: "list",
  ...
  const node101Section: MenuSectionData = {
    type: "list",
  ...
  const corporateSections: MenuSectionData[] = [
    {
      type: "list",
